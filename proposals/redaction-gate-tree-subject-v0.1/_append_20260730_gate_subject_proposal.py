# Append the narrow 【提案】 to peer-chat via the host-clock helper.
...
MSG = os.path.join(HERE, "_msg_20260730_gate_subject_proposal.txt")
...
argv = [
    ...
    "--field", "from=claude",
    "--field", "re=2026-07-30T13:11:08+09:00",
    "--field", "text=" + text,
]
