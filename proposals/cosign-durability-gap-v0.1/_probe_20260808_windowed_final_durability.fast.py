...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                   "_probe_20260808_windowed_final_durability.fast.out.json")
...
def main():
    ...
    disk = {}  # fast variant: skip full-disk walk (83k files/5.3GB); on_disk/disk_path = None
    rows = []
    ...
    for j in judged:
        ...
        uniq.append(j)
    payload = {
        "probe": "_probe_20260808_windowed_final_durability.fast.py",
